...
#import misc
from phyloselect.mgltools.mglutil.util import misc
...
from phyloselect.mgltools.PyBabel.babelElements import babel_elements
...
class Molecule(TreeNode):
    ...
    """
    from phyloselect.mgltools.MolKit.radii_patterns import AtomRadiiPatterns, AAradii
    compiled_patterns = []
