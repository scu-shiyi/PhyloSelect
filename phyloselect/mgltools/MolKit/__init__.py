...
def Read(filename, modelsAs='molecules'):
    ...
    # from phyloselect.mgltools.MolKit.mmcifParser import MMCIFParser
    ext = filename.split('.')
    if ext[-1]=='pdb':
...
#     from phyloselect.mgltools.MolKit.pdbWriter import PdbWriter
#     writer = PdbWriter()
...
# """
#     from phyloselect.mgltools.MolKit.molecule import Atom, AtomSet
#     from phyloselect.mgltools.MolKit.protein import Protein, Chain, Residue
#
#
...
#
# ##  from phyloselect.mgltools.MolKit.protein import ProteinSet, Protein,ResidueSet, Residue, ChainSet, Chain
# ##  from phyloselect.mgltools.MolKit.molecule import AtomSet, Atom, MoleculeSet, Molecule
#
