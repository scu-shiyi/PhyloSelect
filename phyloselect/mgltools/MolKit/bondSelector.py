...
from phyloselect.mgltools.MolKit.molecule import Bond, BondSet, AtomSet
    ...
    def select(self, bnds, cutoff=7.5):
        ...
        for ring in rf.rings:
            ...
            for bnd in blist:
                ...
                #theta is the critical example.csv for planarity:
                #if angle between 2 nrms is 0, atoms are planar
                #NB>example.csv is comparing theta,cos(angle), w/zero
