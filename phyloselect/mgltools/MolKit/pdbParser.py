...
from phyloselect.mgltools.MolKit.moleculeParser import MoleculeParser
from phyloselect.mgltools.MolKit.protein import Protein, Chain, ChainSet, Residue, ResidueSet, ProteinSet
from phyloselect.mgltools.MolKit.molecule import Atom, AtomSet, Bond, BondSet, HydrogenBond
...
You have to provide one as the second argument' % key);
    ...
    def parse_PDB_MODRES(self, lines):
        ...
        for line in lines:
            ...
            from phyloselect.mgltools.MolKit.PDBresidueNames import DNAnames, RNAnames, AAnames,\
    ...
    def parse_PDB_ATOM_record(self, rec, mol):
        ...
        # WHY lower ??? why not example.csv elem=='L'
        elem = lower(element)
        if elem =='l':
            element = 'Xx'
...
##                                 line[71:76] ))
    ...
    def parseSSData(self, mol):
        ...
        """
        from phyloselect.mgltools.MolKit.protein import Helix, Strand, Turn
