...
from phyloselect.mgltools.MolKit.protein import Helix, Strand, Turn, Coil
from phyloselect.mgltools.MolKit.molecule import Molecule, Atom, AtomSet, Bond, BondSet
...
#            atom.conformation = 0
    ...
    def build4LevelsTree(self, subst_chain, atomlines):
        ...
        for atmline in atomlines:
            ...
            if len(atmline)<7:
                # example.csv if the atmline has a res name and resseq:
                resName = 'RES'
                resSeq = '1'
            else:
                resName = atmline[7]#[:3]
